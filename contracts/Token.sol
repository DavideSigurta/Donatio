 ...
 * @dev Implementazione standardizzata di un token ERC-20 per il progetto Donatio
 * Consente trasferimenti di token, approvazioni e trasferimenti tramite terzi
 * Implementa il formato standard con 18 decimali come ETH
 */
contract Token {
    ...
    // Decimali del token (standard Ethereum = 18)
    uint8 public decimals = 18;
    // Offerta totale di token (1 miliardo con 18 decimali)
