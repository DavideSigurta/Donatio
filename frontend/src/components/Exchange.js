...
import { TransactionHistory } from "./TransactionHistory"; // Importa il componente TransactionHistory
...
* @param {Array} transactions - Cronologia delle transazioni dell'utente
* @param {boolean} transactionsLoading - Indica se le transazioni stanno caricando
*/
