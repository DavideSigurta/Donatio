  ...
  export function CampaignDetailPage() {
    ...
    const { selectedAddress, tokenData, makeDonation } = useWeb3();
    ...
    const handleDonation = async (amount, message = "") => {
      try {
        ...
        // AGGIUNGI QUESTA PARTE: Ricarica anche le milestone
    ...
    return (
      ...
      <p><strong>Stato:</strong> {campaign.active ? "Attiva" : "Inattiva"}</p>
      </div>
      </div>
      </div>
      </div>
